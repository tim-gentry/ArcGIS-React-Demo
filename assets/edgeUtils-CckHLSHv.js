import{f4 as T,b9 as M,dn as m,jf as h,cC as I,aT as x}from"./index-DX0rcHuW.js";import{o as g}from"./floatRGBA-DZ6CgOhi.js";import{a as S}from"./DecodeSymbolColor.glsl-CpAWHGzb.js";import{a as E,b as w,s as F,o as O,t as y,c as L,d as u,e as P,f as b,g as v,h as p,i as V}from"./Matrix4PassUniform-CTNrzJ6Q.js";import{o as N}from"./Float4DrawUniform-X0Lc1Ix0.js";import{a as $}from"./BindType-BmZEZMMh.js";import{o as n}from"./interfaces-B8ge7Jg9.js";import{e as s}from"./VertexAttribute-BnAa5VW0.js";function W(o){return o.type==="fill"}function A(o){return o.type==="extrude"}var i;(function(o){o[o.INVISIBLE=0]="INVISIBLE",o[o.TRANSPARENT=1]="TRANSPARENT",o[o.OPAQUE=2]="OPAQUE"})(i||(i={}));class R extends E{constructor(r,e){super(r,"int",$.Draw,(t,a,l)=>t.setUniform1i(r,e(a,l)))}}var c;(function(o){o[o.Uniform=0]="Uniform",o[o.Varying=1]="Varying",o[o.COUNT=2]="COUNT"})(c||(c={}));const f=429496.7296;function oo(o,r){g(o/f*.5+.5,r)}function eo(o,r){switch(r.componentData){case c.Varying:return z(o,r);case c.Uniform:return U(o,r);case c.COUNT:return;default:T(r.componentData)}}function z(o,r){const{vertex:e,fragment:t}=o;e.include(w),e.uniforms.add(new F("componentColorTex",l=>l.componentParameters.texture.texture)),o.attributes.add(s.COMPONENTINDEX,"float"),o.varyings.add("vExternalColorMixMode","mediump float"),o.varyings.add("vExternalColor","vec4");const a=r.output===O.ObjectAndLayerIdColor;a&&o.varyings.add("vObjectAndLayerIdColor","vec4"),o.include(S),e.constants.add("elevationScale","float",2*f),e.constants.add("stride","float",M("enable-feature:objectAndLayerId-rendering")?3:2),e.code.add(n`vec2 getComponentTextureCoordinates(float componentIndex, float typeOffset) {
...
`)}function to(o,r){const e=o.vertex;e.include(w),o.include(y,r),e.uniforms.add(new L("distanceFalloffFactor",t=>t.distanceFalloffFactor)),e.code.add(n`float distanceBasedPerspectiveFactor(float distance) {
...
}`)}function ro(o){return o===d.Sketch||o===d.Mixed}var d,C;(function(o){o[o.Solid=0]="Solid",o[o.Sketch=1]="Sketch",o[o.Mixed=2]="Mixed",o[o.COUNT=3]="COUNT"})(d||(d={})),function(o){o[o.REGULAR=0]="REGULAR",o[o.SILHOUETTE=1]="SILHOUETTE"}(C||(C={}));function no(o){return o&&o.enabled&&(A(o)||W(o))&&o.edges!=null}function D(o){return o&&o.enabled&&o.edges||null}function ao(o,r){return j(D(o),r)}function j(o,r){if(o==null)return null;const e=o.color!=null?h(I.toUnitRGBA(o.color)):m(0,0,0,0),t=x(o.size),a=x(o.extensionLength);switch(o.type){case"solid":return _({color:e,size:t,extensionLength:a,...r});case"sketch":return H({color:e,size:t,extensionLength:a,...r});default:return}}function _(o){return{...G,...o,type:d.Solid}}function H(o){return{...k,...o,type:d.Sketch}}const G={color:m(0,0,0,.2),size:1,extensionLength:0,opacity:1,objectTransparency:i.OPAQUE,hasSlicePlane:!1},k={color:m(0,0,0,.2),size:1,extensionLength:0,opacity:1,objectTransparency:i.OPAQUE,hasSlicePlane:!1};export{i as A,oo as C,ao as a,no as c,j as f,_ as g,eo as m,d as p,c as s,ro as u,to as v,C as x};
